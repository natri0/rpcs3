...
namespace clan
{
    ...
    class clan_client
    {
        private:
			...
			SceNpClansError sendRequest(std::string endpoint, ClanManagerType type, pugi::xml_document* xmlBody, pugi::xml_document* outResponse);
